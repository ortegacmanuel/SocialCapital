...
$('body').on('DOMNodeInserted', function(e) {
    ...
    profileCard.children('.profile-header-inner').prepend('<div class="social-capital-number profile-header-inner"><a data-tooltip="' + window.sL.socialCapitalTooltip + '" href="' + window.siteInstanceURL + 'socialcapital/index/' + userData.id + '">' + userData.social_capital + '</a></div>');
});
